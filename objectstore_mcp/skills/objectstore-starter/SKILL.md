---
name: objectstore-starter
description: >-
  Objectstore API + MCP Server + A2A Server Use when working with Objectstore via this package's MCP
...
license: MIT
tags: [objectstore-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Objectstore Starter Skill

Starter skill for the **Objectstore** package. Use the `mcp-client` universal skill
